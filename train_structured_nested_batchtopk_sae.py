...
def main() -> None:
    ...
    targets = [
        {
            "label": "structured-cache BatchTopK base-only",
            "kind": "batchtopk",
            "layer": args.layer,
        ...
        {
            "label": "structured-cache sample-nested BatchTopK SAE",
            "kind": "batchtopk",
            "layer": args.layer,
    ...
    summary = {
        "experiment": "parameter-matched structured-cache nested BatchTopK SAE",
        "arguments": {
