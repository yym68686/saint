...
CODE="${CODE:-/autodl-fs/data/worktrees/saint-structured-nested-batchtopk-v2}"
...
ROOT="${ROOT:-/autodl-fs/data/structured_nested_batchtopk_v2_20260710}"
...
payload = {
    "experiment": "sample-nested shared-dictionary BatchTopK SAE v2 screen",
    ...
    "method_basis": {
        ...
        "measured_predecessor": "sample-nested shared-dictionary ReLU v1",
        "predecessor_initial3_delta": -0.002256944444444464,
        "predecessor_positive_cells": {
            "bias_set3": 0.007291666666666696,
            "amazon_category": 0.009375000000000022,
            "ag_news_top1": 0.015625,
        },
        "predecessor_failure": {
            "ag_news_top2": -0.03125,
            "ag_news_top5": -0.0546875,
            "candidate_outer_mean_acc": 0.7185329861111112,
            "base_suffix_mean_acc": 0.8101128472222222,
            "candidate_outer_l0": 1041.88671875,
            "base_suffix_l0": 907.5869140625,
        },
        "controlled_mechanism_change": (
            "replace broad ReLU-L1 codes with the repository-standard global "
            "minibatch BatchTopK competition at k=64 for both token and inner "
            "sample-mean paths"
        ),
    },
    "data": {
...
report = {
    ...
    "decision": (
        ...
        if gate["gate"]["pass"]
        else "stop-v2-before-long-train"
    ),
    "full7_ran": False,
}
