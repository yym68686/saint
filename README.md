...
SAE_ARCHITECTURE=denseimq python compare_feature_activation_between_datasets.py --llama_model_dir ./llama_3.2-3B_model/original --sae_model_path ./trained_sae.pt --sae_layer_idx 22 --feature_index 1189 --control_target_dir ./ablation_datasets-dense/female_subjects --output_path ./ablation_datasets-dense/female_subjects/denseimq-l22-f1189/feature_activation_summary.json --save_per_sample
```
