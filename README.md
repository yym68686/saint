...
SAE_ARCHITECTURE=denserepreg python compare_feature_activation_between_datasets.py --llama_model_dir ./llama_3.2-3B_model/original --sae_model_path ./trained_sae.pt --sae_layer_idx 22 --feature_index 27807 --control_target_dir ./ablation_datasets-dense/football --output_path ./ablation_datasets-dense/football/denserepreg-l22-f27807/feature_activation_summary.json --save_per_sample
```
