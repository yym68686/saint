...
SAE_ARCHITECTURE=imq python compare_feature_activation_between_datasets.py --llama_model_dir ./llama_3.2-3B_model/original --sae_model_path ./exp-imq-mmd-dict-reg.pt --sae_layer_idx 22 --feature_index 49592 --control_target_dir ./ablation_datasets-dense/indian_politics --output_path ./ablation_datasets-dense/indian_politics/imq-l22-f49592/feature_activation_summary.json --save_per_sample
```
