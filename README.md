...
SAE_ARCHITECTURE=leech python compare_feature_activation_between_datasets.py --llama_model_dir ./llama_3.2-3B_model/original --sae_model_path ./exp-repulsion-scheduled-warmup.pt --sae_layer_idx 22 --feature_index 12116 --control_target_dir ./ablation_datasets-dense/female_subjects --output_path ./ablation_datasets-dense/female_subjects/leech-l22-f12116/feature_activation_summary.json --save_per_sample
```
