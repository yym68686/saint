...
SAE_ARCHITECTURE=sigregrepreg python compare_feature_activation_between_datasets.py --llama_model_dir ./llama_3.2-3B_model/original --sae_model_path ./exp-dict-sigreg-repulsion-both.pt --sae_layer_idx 22 --feature_index 40102 --control_target_dir ./ablation_datasets-dense/football --output_path ./ablation_datasets-dense/football/sigregrepreg-l22-f40102/feature_activation_summary.json --save_per_sample
```
